<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light py-4" id="ftco-navbar">
    <div class="container">
        ...
        <form action="{{ route('search') }}" method="post" class="searchform order-sm-start order-lg-last">
            @csrf
        ...
        <div class="navbar-collapse collapse show ml-5" id="ftco-nav">
            <ul class="navbar-nav">
                <li class="nav-item active"><a href="{{url('member/home')}}" class="nav-link">Home</a></li>
                ...
                <li class="nav-item"><a href="{{url('member/sanpham')}}" class="nav-link">Quản lý sản phẩm</a></li>
                <li class="nav-item"><a href="{{url('member/baiviet')}}" class="nav-link">Bài viết</a></li>
                <li class="nav-item"><a href="{{url('member/lichsu')}}" class="nav-link">Lịch Sử</a></li>
