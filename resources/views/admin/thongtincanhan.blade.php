                    ...
                    <div class="card-body">
                        ...
                        <form  class="form-horizontal form-material" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="file"  class="form-control form-control-line"  name="anh">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" value="{{$data->password}}" class="form-control form-control-line" name="password" readonly>
                                </div>
                            </div>
                            <div class="form-group">
